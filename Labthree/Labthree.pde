...
class SimulationThread implements Runnable {
  ...
  public void run() {
    ...
    if (s.h_avatar.isTouchingBody(b3)) {
      ...
      right.setPosition(18, 10.9);
      left.setPosition(6, 10.9);
      bottom.setPosition(12.75, 16.3);
    }
...
void drawWater(float f, float s) {
  ...
  for (int i = 1; i < 4; i++) {
    createJoint(i-1, i, f, particles);
    createJoint(i-1, i+3, f, particles);
  }
  ...
  createJoint(3, 7, f, particles);
  createJoint(7, 11, f, particles);
  createJoint(11, 15, f, particles);
  right.setPosition(16.8, 10.9);
  left.setPosition(8.75, 10.9);
  bottom.setPosition(12.75, 16.3);
  world.add(left);
...
void createJoint(int i, int j, float f, FBody[] particles) {
