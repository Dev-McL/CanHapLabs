...
String img_file_path = "/Users/champmaya/Documents/Arduino/CanHap501/project_iteration2_DM_v2/img/";
 ...
 */
haplyBoard          = new Board(this, Serial.list()[1], 0); //new Board(this, Serial.list()[0], 0);
...
if (Tool1.isOn()==true){    
   ...
   if (Tool3.isOn()==true){          
    if (counter_stage>=1) {
    image(Tool3_vertical,265+800,33+Tool_displacements[counter_stage]);}
    else {
    image(Tool3_vertical,265+800,-16+Tool_displacements[0]);
    }
}
   if (Tool4.isOn()==true){          
    if (counter_stage>=1) {
